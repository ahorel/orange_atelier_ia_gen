...
class ETAPE4_modelML_warmStart:
    ...
    def __init__(self, evollis_path: str, hybris_path: str):
        ...
        self.model_path = str(_MODELS_DIR / "xgb_origin_model.json")
...
if __name__ == "__main__":
    workshop = ETAPE4_modelML_warmStart(
    ...
    df_final.to_csv(str(Path(__file__).parent / "ETAPE4_modelML_warmStart.csv"), sep=";", index=False)
