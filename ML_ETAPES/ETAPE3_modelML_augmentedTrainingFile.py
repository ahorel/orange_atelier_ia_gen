...
# Permet d'importer ETAPE3_filesData_generator depuis le même répertoire
...
class ETAPE3_modelML_augmentedTrainingFile:

    def __init__(self, evollis_path: str, hybris_path: str):
        self.evollis_path = evollis_path
        self.hybris_path = hybris_path
        
        gen_hyb_prod.generate_files("evollis")
        gen_hyb_prod.generate_files("hybris")
        self.ORIGIN_LABELS = {
            0: "EVOLLIS",
            1: "HYBRIS"
        }
...
if __name__ == "__main__":
    workshop = ETAPE3_modelML_augmentedTrainingFile(
    ...
    df_final.to_csv(str(Path(__file__).parent / "ETAPE3_modelML_augmentedTrainingFile.csv"), sep=";", index=False)
